...
public class SampleChild extends SampleParent{
	...
	//-상속받은 변수가 맘에안들때 바꾸는것
	//super, super()
	//-부모클래스의 멤버와 자식클래스멤버가 동일할 때 super
	//-부모클래스의 생성자를 나타낼때 super()
	//다형성
	...
	@Override
	int method(int a ,int b){//리턴타입 메서드명 피라미터 모두 같아야 한다.
		return a * b;
	}
	...
	void test(double var){
		...
		//부모클래스의 멤버와 자식 클래스의 멤버가이름이 중복될 때 둘을 구분하기 위해 사용한다.
		System.out.println(this.method(10, 20));
		System.out.println(super.method(15,10));
	...
	SampleChild(){
		...
		//super()가 없으면컴파일러가 자동으로 super()를 넣어준다.
